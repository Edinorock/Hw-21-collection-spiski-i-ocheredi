...
public class Main {
    ...
    public static void printInfoByBus(Bus bus) {
        System.out.println("Информация об автобусе:" +
                ...
                ", тип вместимости - " + bus.getCapacity());
    }
    ...
    public static void printInfoByTruck(Truck truck) {
        System.out.println("Информация о грузовике:" +
                ...
                ", тип грузоподъёмности - " + truck.getWeight());
    }
    ...
    public static void main (String[]args){
        ...
        Truck gaz = new Truck("ГАЗ", "3300 Садко", 2.5, Weight.N_2);
        Truck gazon = new Truck("ГАЗон", "Next", 3.6, Weight.N_1);
        ...
        Bus gazelle = new Bus("Газель", "Next A63R42", 1.5, Capacity.N2);
        ...
        Sponsor Reebok =  new Sponsor("Reebok",50000);
